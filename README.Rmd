...
To incorporate survey fetches into your data collection pipeline, install your Qualtrics credentials using the following code:

```{r}
qualtRics::qualtrics_api_credentials(api_key = "nMNZz9DksEX2m8pefqeyJebdessGS41VZleBsUDC",
...
```{r}
all_timeline_data <- loadTimelines(study_name = "my_first_study", panel_name = "random_tweeters")
