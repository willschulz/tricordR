...
if (length(user_ids)>20) {user_ids <- user_ids[1:20]} #if there are more than 20, take the first 20 for a rapid demonstration
...
if (nrow(popular_friends)>20) {popular_friends <- popular_friends[1:20,]} #if there are more than 20, take the 20 most popular
