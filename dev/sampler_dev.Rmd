...
getSampledUsersFriends <- function(study_name, token, minutes = 1){
  sampled <- dir(paste0("~/tricordings/studies/",study_name,"/1_user_ids_streamed"), full.names = T) %>% sapply(., readRDS)
